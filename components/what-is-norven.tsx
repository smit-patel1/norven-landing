    ...
    <section className="py-12 sm:py-16 px-4 sm:px-6 bg-surface/30">
      <div className="container mx-auto max-w-3xl">
        <div className="space-y-4 sm:space-y-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground">The execution gap in enterprise agent systems</h2>

          <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-foreground-secondary">
          ...
          <p className="text-sm sm:text-base text-foreground-secondary pt-2">
