      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="border border-border bg-card p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="text-sm font-semibold text-primary mb-2">Agent reasoning layer</div>
            ...
            <div className="border border-primary/40 bg-surface-elevated p-6 rounded-lg relative overflow-hidden shadow-md hover:shadow-lg transition-all group">
              ...
              <div className="relative">
                <div className="text-sm font-semibold text-primary flex items-center gap-2 mb-2">
            ...
            <div className="border border-border bg-card p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="text-sm font-semibold text-primary mb-2">Enterprise infrastructure</div>
